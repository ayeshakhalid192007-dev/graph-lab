    ...
    <div className="w-full overflow-x-auto">
      ...
      >
        ...
        <g transform="translate(80, 70)">
          {/* Box with explicit fill */}
          <rect x="0" y="0" width="160" height="80" rx="8" fill="var(--surface)" stroke="var(--accent-primary)" strokeWidth="2" />
          {/* Icon */}
          <rect x="12" y="12" width="36" height="36" rx="4" fill="var(--accent-primary/15)" />
          ...
          <text x="80" y="48" textAnchor="middle" dy="0.35em" fill="var(--muted)" style={{ fontFamily: 'var(--font-mono)', fontSize: '10px' }}>
            prose in, schema out
          </text>
          {/* Arrow */}
          <line x1="160" y1="40" x2="200" y2="40" stroke="var(--accent-primary)" strokeWidth="2" strokeLinecap="round" markerEnd="url(#arrow)" />
        </g>

        {/* Stage 2: Resolution */}
        <g transform="translate(320, 70)">
          {/* Box with explicit fill */}
          <rect x="0" y="0" width="160" height="80" rx="8" fill="var(--surface)" stroke="var(--accent-secondary)" strokeWidth="2" />
          {/* Icon - merge symbol */}
          <circle cx="24" cy="18" r="10" fill="var(--accent-secondary/15)" />
          <circle cx="54" cy="42" r="10" fill="var(--accent-secondary/15)" />
          ...
          {/* Arrow */}
          <line x1="160" y1="40" x2="200" y2="40" stroke="var(--accent-secondary)" strokeWidth="2" strokeLinecap="round" markerEnd="url(#arrow-secondary)" />
        </g>

        {/* Stage 3: Provenance */}
        <g transform="translate(560, 70)">
          {/* Box with explicit fill */}
          <rect x="0" y="0" width="160" height="80" rx="8" fill="var(--surface)" stroke="var(--accent-tertiary)" strokeWidth="2" />
          {/* Icon - receipt/certificate */}
          <path d="M24 18H48V22H24V18ZM24 26H48V40H24V26ZM24 44H48V50H24V44Z" fill="var(--accent-tertiary/15)" />
        ...
        <g transform="translate(200, 170)">
          <rect x="0" y="0" width="400" height="35" rx="17.5" fill="var(--surface)" stroke="var(--rule)" strokeWidth="1" />
          <text x="200" y="22" textAnchor="middle" dy="0.35em" fill="var(--graphite)" style={{ fontFamily: 'var(--font-mono)', fontSize: '11px' }}>
