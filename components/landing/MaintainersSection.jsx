...
export function MaintainersSection() {
    return (<Section id="maintainers">
      <div className="mb-12">
        <p className="mono text-xs uppercase tracking-widest text-accent-primary font-semibold">
          Who&apos;s behind this
        </p>
      ...
      <div className="grid max-w-3xl gap-6 sm:grid-cols-2">
        {MAINTAINERS.map((m) => (<a key={m.name} href={m.github} target="_blank" rel="noopener noreferrer" className="group rounded-xl border border-rule bg-surface/40 p-8 transition-all duration-200 hover:border-accent-primary hover:bg-surface/60">
            <div className="flex h-14 w-14 items-center justify-center rounded-full border border-accent-primary/30 bg-accent-primary/10 font-display text-lg font-bold text-accent-primary">
              {m.initials}
            </div>
            <div className="mt-4">
            ...
            <div className="mt-6 inline-flex items-center gap-2 text-sm text-muted group-hover:text-accent-primary transition-colors">
