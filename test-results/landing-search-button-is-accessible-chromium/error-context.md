...
- Name: landing.spec.ts >> search button is accessible
- Location: tests/landing.spec.ts:19:5
...
Locator: getByRole('button', { name: 'Search' }).first()
Expected: visible
Timeout: 5000ms
